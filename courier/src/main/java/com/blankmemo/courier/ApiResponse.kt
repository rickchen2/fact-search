...
import com.blankmemo.courier.exceptions.NoContentException
import com.blankmemo.courier.operators.ApiResponseOperator
import com.blankmemo.courier.operators.ApiResponseSuspendOperator
...
sealed class ApiResponse<out T> {
    ...
    companion object {
        ...
        @JvmSynthetic
        inline fun <T> of(
            successCodeRange: IntRange = CourierInitializer.successCodeRange,
        ...
        /**
         * Operates if there is a global [com.blankmemo.courier.operators.CourierOperator]
        ...
        internal fun <T> ApiResponse<T>.operate(): ApiResponse<T> = apply {
            val globalOperator = CourierInitializer.courierOperator ?: return@apply
            if (globalOperator is ApiResponseOperator<*>) {
                ...
                val context = CourierInitializer.courierOperatorContext
